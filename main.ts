...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    pizza_1.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    info.startCountdown(2)
})
let pizza_1: Sprite = null
...
pizza_1 = sprites.create(img`
    ...
    44ee...4e.......................
    `, SpriteKind.Food)
pizza_1.setScale(0.5, ScaleAnchor.Middle)
